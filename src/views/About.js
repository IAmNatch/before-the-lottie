			...
			<div key="aboutPage">
				...
				<div className="description">
					...
					<p>
						...
						between the urban consumer and farming in Canada. Modern
						consumers are increasingly interested in where and how
						their food gets to them, but accurate information is
						hard to come by and often feels out of reach. Before The
						Plate follows young farmers and industry experts in
						order to show the general population what a modern
						Canadian farm operation looks like, and answer the most
						pressing questions consumers have about their food. The
						film will follow food staples of the Canadian diet all
						the way from the farm to the harvesting and processing
						operations, and showcase the final product at Canoe, one
						of Toronto's most prestigious restaurants. The project
						will follow various types of agriculture, including both
						organic and conventional practices to answer some of the
						biggest questions related to farming in our society.
					</p>
				</div>
